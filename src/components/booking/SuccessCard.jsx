    ...
    return (
        <div className='font-[roboto] text-center flex flex-col items-center gap-6 justify-center w-full rounded-md border py-10 px-4'>
            ...
            <div className='text-md text-gray-700'>
                ...
                <p>An automated payment receipt will be sent to your registered email</p>
            </div>
            <div className='flex flex-wrap items-center justify-center gap-2'>
                <p>Check your Booking History on</p>
                <Button variant="outline" onClick={() => navigate('/dashboard')} className='rounded-full font-semibold font-[raleway]'>Dashboard</Button>
            </div>
        </div>
    )
}
