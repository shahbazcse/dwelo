            ...
            {!showSuccessCard ? (
                <section className="bg-white border rounded-md text-gray-600 p-4">
                    <div className="flex justify-center mb-6 rounded-md bg-gray-100 p-1">
                        <button
                            onClick={() => setTogglePayment("CC")}
                            className={`${togglePayment === "CC" && "rounded-md border shadow-sm bg-white"
                                } relative flex-1 text-sm font-medium p-1 transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2`}
                        >
                            Pay With Card
                        </button>
                        <button
                            onClick={() => setTogglePayment("POA")}
                            className={`${togglePayment === "POA" &&
                    ...
                    {togglePayment === "CC" ? (
                        <div className="space-y-4">
                                ...
                                <div>
                                    <div className="flex items-start justify-between">
                                        ...
                                        <p
                                            ...
                                            className="text-xs px-1.5 bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-400 rounded-lg"
                                        >
                                            Genrate Random
                                        </p>
                                    </div>
                                    <Input
                                        ...
                                        onChange={(e) => setFormData({ cardNo: e.target.value })}
                                        className="font-[roboto] text-md tracking-wide font-semibold focus-visible:ring-transparent focus-visible:ring-0 placeholder:text-gray-300"
                            ...
                            <p className="text-xs opacity-70 font-[roboto]">
                                By selecting the button below, I agree to the Dwelo's Rules,
                                Ground rules for guests, Dwelo's Rebooking and Refund Policy,
                                and that Dwelo can charge my payment method if I'm responsible
                                for damage.
                            </p>
                            <button
                        ...
                        <div className="space-y-4">
                            <div className="text-sm font-[roboto] leading-5">
                                Please note that payment is due upon arrival. We accept cash,
                                credit/debit cards. If you have any questions or concerns
                                regarding payment, feel free to contact us. We look forward to
                                serving you!
                            </div>
                            <p className="text-xs opacity-70 font-[roboto]">
                                By selecting the button below, I agree to the Dwelo's Rules,
